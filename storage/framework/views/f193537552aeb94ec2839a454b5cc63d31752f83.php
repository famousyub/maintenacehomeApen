...
} elseif ($_instance->childHasBeenRendered('8bX01bZ')) {
    $componentId = $_instance->getRenderedChildComponentId('8bX01bZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('8bX01bZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8bX01bZ');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('8bX01bZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH D:\wampp\www\crawlerr\src\MicroweberPackages\Admin/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>